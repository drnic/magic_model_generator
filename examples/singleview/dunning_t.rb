class DunningT < ActiveRecord::Base
  ...
  validates_numericality_of :dunning_action_code, :allow_nil => true, :only_integer => true
  validates_numericality_of :current_ind_code, :allow_nil => true, :only_integer => true
end
